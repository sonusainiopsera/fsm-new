...
/**
 * Purpose-built payload record for the {@code PartsReturned} event type.
 */
public record PartsReturnedPayload(
        UUID workOrderId,
        UUID locationId,
        List<LineItem> lines,
        UUID actorUserId,
    ...
    public static final String EVENT_TYPE = "PartsReturned";
