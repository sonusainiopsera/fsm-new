/**
 * @fileoverview DetailDrawer — slide-in panel sharing the overlay primitive.
 * Same focus trap / Escape / scrim rules as Modal.
 */
 ...
 * }} props
 */
export function DetailDrawer({ open, onClose, title, children, width = '480px' }) {
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          borderRadius: `var(--token-radius-overlay) 0 0 var(--token-radius-overlay)`,
      ...
      >
        ...
        {/* Body */}
        <div style={{ padding: 'var(--token-space-6)', flex: 1 }}>
          {children}
        </div>
      </div>
    </div>
